...
resource "keycloak_openid_client_scope" "modern_devops_stack_mlflow_policy" {
  realm_id               = resource.keycloak_realm.modern_devops_stack.id
  name                   = "mlflow-policy"
...
resource "keycloak_openid_user_attribute_protocol_mapper" "modern_devops_stack_mlflow_policy" {
  realm_id             = resource.keycloak_realm.modern_devops_stack.id
  client_scope_id      = resource.keycloak_openid_client_scope.modern_devops_stack_mlflow_policy.id
  name                 = "mlflow-policy"
